...
class AppController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      elseif($request->_option == 6){
        ...
        ."-----의료 정보-----\n"
        ."보호자 전화번호 : ". isset(\App\Medical_info::whereUser_id($request->_key)->first()->guardian_phone) ? \App\Medical_info::whereUser_id($request->_key)->first()->guardian_phone : "" ."\n"
        ."혈액형 : ". isset(\App\Medical_info::whereUser_id($request->_key)->first()->blood_type) ? \App\Medical_info::whereUser_id($request->_key)->first()->blood_type : "" ."\n"
        ."기타메시지 : ". isset(\App\Medical_info::whereUser_id($request->_key)->first()->report_request) ? \App\Medical_info::whereUser_id($request->_key)->first()->report_request : "" ."\n"
        ."-----병력-----\n"
        .substr($sickness , 0, -1)."\n"
        ."-----과거 병력-----\n"
