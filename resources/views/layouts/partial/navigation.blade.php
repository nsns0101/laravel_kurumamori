<section id="main-navigation">
    <nav class="navbar fixed-top navbar-expand-lg" style="background-color:#002ef0; opacity:1; color:white">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav mr-auto col-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/boards/questions" style="color:white">고객 문의</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/boards/reviews" style="color:white">고객 리뷰</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav col-auto">
                @if(Auth::user())
                <li class="nav-item">
                    <a class="nav-link" href="/info/index" style="color:white">내정보</a> 
                </li>
                <li class="nav-item">
                ...
                @else
                <li class="nav-item">
                    <a class="nav-link" href="/auth/login" style="color:white">로그인</a>
                </li> 
                <li class="nav-item">
