import React, {Fragment, useState, useEffect, setState, useContext}from "react";
                        ...
                        <div className="row justify-content-around">
                            <div className="col-sm-12 col-lg-10 text-left" style={{paddingTop:100+'px'}}>
                                <ScrollAnimation animateIn='fadeInLeft' animateOnce={true} duration={0.5}>
                                    <h1 className="pb-5" style={{color:"black",fontWeight:800}}>{t("알고리즘")}</h1>       
                                </ScrollAnimation>
                                <div className="row justify-content-around">
                                    <div className="col-sm-12 col-lg-10">
                                        ...
                                        <ScrollAnimation animateIn='fadeInUp' animateOnce={true}>  
                                            <div className="row justify-content-around mx-0 px-0 py-5">
                                                <h3 style={{fontWeight:900,color:'#3E3E45'}}>{t("졸음 운전에 의한 사망율")}</h3>
                                                <h3 className="py-1" style={{color:"black",fontWeight:900,fontSize:2+'em'}}>{t("고속도로 사망원인 중 1위")}</h3>
                                    ...
                                    <div className="col-sm-12 col-lg-10">
                                        <div className="pt-5">
                                            <ScrollAnimation animateIn='fadeInUp' animateOnce={true}>
                                                <div>
                                                    <h2 style={{fontWeight:900,color:'#3E3E45'}}>{t("골든 타임의 중요성")}</h2>
                                                    <h2 className="py-1" style={{color:"black",fontWeight:900,fontSize:2.5+'em'}}>{t("자동 신고 서비스")}</h2>
                                                    <div className="py-3">
                                                        <h4 style={{fontWeight:500,color:'#3E3E45'}}>{t("자동 신고 서비스는 돌발적으로 발생하는 사고 상황을 하드웨어가 판단하여 자동으로 119에 신고해주는 서비스입니다.")}</h4>
                                                        <h4 style={{fontWeight:500,color:'#3E3E45'}}>{t("사고가 발생하면 경보가 울리게 되는데 제한시간내에 운전자가 하드웨어의 취소버튼을 누르지 않으면 운전자가 취소를 할 수 없는 상태로 판단하여 자동으로 119에 신고를 하게 됩니다.")}</h4>
                                                        <h4 style={{fontWeight:500,color:'#3E3E45'}}>{t("신고 시 등록했던 의료 정보와 현재 사고 위치 정보를 함께 119에 전송함으로써 현장 출동의 골든 타임이 보장될 수 있도록 돕습니다.")}</h4>
                                                    </div>   
                                                </div>  
                                            </ScrollAnimation>
                                            <ScrollAnimation animateIn='fadeInUp' animateOnce={true} duration={0.9}>
