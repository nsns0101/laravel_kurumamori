                        ...
                        <ScrollAnimation animateIn='fadeIn' animateOnce={true}>  
                            <div className="pt-5">
                                <div className="pt-4 pb-2">
                                    <h4 style={{fontWeight:700}}>{t("クルマモリ9의 생생한 후기.")}</h4>
                                </div>
                                <div>
                            ...
                            <div className="row justify-content-around px-0 mx-0 pb-5">
                                ...
                                <div className="row col-sm-10 col-lg-10 justify-content-around px-0 mx-0">
                                    ...
                                    <div className="col-sm-12 col-lg-8 text-left">
                                        <h4>
                                            {t("사실 처음 사용할 때는 많이 필요가 없다고 생각을 하고 사용했습니다. 안전을 위해서 어느 정도 투자한다는 생각으로 가볍게 구매했는데 써보니까 생각보다 더 좋더라구요. クルマモリ9 저는 강력하게 추천합니다. 운전 습관을 고치니까 연비도 더 절약하게 되었고 장거리 운전을 하는 저로서는 졸음 운전 걱정이 많았는데 확실히 해결 되었구요. 여러모로 두번 추천합니다.")}
                                        </h4>
                                    </div>
                                </div>
                            </div>
