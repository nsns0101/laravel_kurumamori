            ...
            <div className="row">
                ...
                <div className="col-md-8 mb-3">
                    <div className="bigdata-card-menu mt-5">
                        <p className="bigdata-text">{t("쿠루마모리119에서 제공되는 졸음운전 데이터입니다.")}</p>
                    ...
                    <div className="bigdata-card-menu mt-5">
                        <p className="bigdata-text">{t("쿠루마모리119에서 제공되는 급가속 급정거 데이터입니다.")}</p>
                        <div className="card sudden-chart border-warning">
                            <div className="row no-gutters">
                                ...
                                <div className="col-8 text-right">
                                    <div className="card-body">
                                        <h5 className="card-title">{t("급정거 급가속")}</h5>
                                        <p className="card-text">{t("급정거와 급가속은 자동차의 수명을 단축시킬 뿐만 아니라, 브레이크 제동거리에 의해 보행자나 자동차와의 접촉사고가 발생할 수도 있습니다. 급정거와 급가속은 지속적으로 운전에 집중하며 조심해야합니다!")}</p>
                                        <p className="card-text">{t("우리 서비스를 이용하는 운전자들은 어떤 사람들이 언제, 어디에서 급가속 / 급정거를 할까요??")}</p>
                                        <p className="card-text">{t("빅데이터 자료실에서 지금 확인해보세요!!!")}</p>
                    ...
                    <div className="bigdata-card-menu mt-5">
                        <p className="bigdata-text">{t("쿠루마모리119에서 제공되는 교통사고 데이터입니다.")}</p>
                        <div className="card accident-chart border-danger">
                            <div className="row no-gutters">
                                ...
                                <div className="col-8 text-right">
                                    <div className="card-body">
                                        <h5 className="card-title">{t("교통사고")}</h5>
                                        ...
                                        <p className="card-text">{t("우리 서비스를 이용하는 운전자들은 언제, 어떤 사람들이, 어디에서 교통사고를 내고 있을까요?")}</p>
                                        <p className="card-text">{t("빅데이터 자료실에서 지금 확인해보세요!!!")}</p>                            
