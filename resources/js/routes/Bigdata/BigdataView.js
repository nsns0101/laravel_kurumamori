                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-8 text-right">
                                    <div className="card-body">
                                        ...
                                        <Link to="/bigdata/sleep" onClick={() => setForm("sleep")} className="btn btn-primary">자세히 보기</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-8 text-right">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">빅데이터 자료실에서 지금 확인해보세요!!!</p>
                                        <Link to="/bigdata/sudden" onClick={() => setForm("sudden")} className="btn btn-primary">자세히 보기</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-8 text-right">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text"> 빅데이터 자료실에서 지금 확인해보세요!!!</p>                            
                                        <Link to="/bigdata/accident" onClick={() => setForm("accident")} className="btn btn-primary">자세히 보기</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
