                ...
                <div className="col-sm-10 col-lg-10 py-5 text-center">
                    <div className="row justify-content-center" style={{height:80+"vh"}}>
                        <div className="col-sm-12 col-lg-10 py-3">
                            <h4 style={{fontSize:"3.5em", color:"black"}}>{t("구매해주셔서 감사합니다.")}</h4>
                            <div className="pt-4">
                                <p style={{fontSize:2.0+"em"}}>{t("kurumamori 119 사용을 위해서 아래 두가지 사항을 미리 준비해주세요!")}</p>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-12 col-lg-8 py-2 mb-4 card">
                            <div className="row mx-0 px-0 justify-content-letf pt-3 pl-3 d-flex flex-row align-items-center">
                                ...
                                <p className="py-0" style={{fontSize:"1.75em", color:"#34394D"}}>{t("제품 등록 및 의료정보 등록하기")}</p>

                            </div>
                            <div className="row mx-0 px-0 justify-content-around pb-3" >
                                <div className="col-sm-12 col-lg-5 py-3">
                                    <div className="py-1" style={{fontSize:2.5+"em", color:"black"}}>{t("구매한 제품 코드")}</div>
                                ...
                                >
                                    <Link to="/info/index" className="nav-link" style={{fontSize:2+"em",color:"white"}}>{t("제품 등록하러 가기")}</Link> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-12 col-lg-8 py-2 card">
                            <div className="row mx-0 px-0 justify-content-letf pt-3 pl-3 d-flex flex-row align-items-center">
                                ...
                                <p className="py-0" style={{fontSize:"1.75em", color:"#34394D"}}>{t("스마트폰 앱스토어에서 쿠루마모리 앱 설치 하기")}</p>
                            </div>
                            <div className="row mx-0 px-0 justify-content-around pb-3" >
