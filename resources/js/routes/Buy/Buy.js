                            ...
                            <div>
                                ...
                                <div className="py-3">
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <p style={{color:"black", fontSize:"24px", fontWeight:"bold"}}>{t("PURCHASER INFORMATION")}</p>
                                        {/* 수신인 정보 */}
                                        ...
                                        <p className="pt-3" style={{color:"black", fontSize:"24px", fontWeight:"bold"}}>{t("RECIPIENT INFORMATION")}</p>
                                        <div className="recipient_information">
                                            {/* 이름 */}
                                            <div className="name row mx-0 px-0 my-0 py-0 align-items-center" style={{borderTop:"2px solid black"}}>
                                                <div className="col-md-3 mx-0 px-0" style={{backgroundColor:"white"}}>
