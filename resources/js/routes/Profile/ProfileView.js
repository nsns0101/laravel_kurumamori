                            ...
                            {data && user.id ? (
                                                ...
                                                <div className="card-body py-3">
                                                    <div className="row">
                                                        <div className="col-lg-6 mb-3">
                                                            <p className="card-text"><b>{t("이메일")}</b><br/>{data.user.email}</p>
                                                        </div>
                                                        <div className="col-lg-6">
                                                            <p className="card-text"><b>{t("이름")}</b><br/>{data.user.name}</p>
                                                        </div>
                                                        ...
                                                        <div className="col-lg-6 mb-3">
                                                            <p className="card-text"><b>{t("휴대폰 번호")}</b><br/>{data.user.phone}</p>
                                                        </div>
                                                        <div className="col-lg-6">
                                                            <p className="card-text"><b>{t("가입날짜")}</b><br/>{moment(data.user.created_at).format("YYYY-MM-DD")}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <ScrollAnimation animateIn='fadeIn' delay={600} animateOnce={true}>
                                            ...
                                            <div className="card">
                                                ...
                                                <div className="card-body py-3">
                                                    {data.product ? (
                                                        <div>                                                      
                                                            <p className="card-text"><b>{t("제품 키")}</b><br/>{data.product.product_key}</p>
                                                            <p className="card-text"><b>{t("구입 날짜")}</b><br/>{moment(data.product_buy.created_at).format("YYYY-MM-DD")}</p>
                                                            <p className="card-text"><b>{t("무상 AS기한")}</b><br/>{t("구입 후 1년까지")}</p>
                                                            {/* float 정렬때문에 삭제가 뒤로감 */}
                                                        ...
                                                        <div>
                                                            <p className="text-center text-danger">{t("등록한 제품이 없습니다.")}</p>
                                ...
                                <div className="row mt-5">
                                    ...
                                    <ScrollAnimation animateIn='fadeIn' animateOnce={true}>
                                            ...
                                            <h4 className="text-center">{t("문의 이력")}</h4>
                                            ...
                                            <p className="text-danger">{t("최근 5건만 표시됩니다.")}</p>
                                        </ScrollAnimation>
                                    </div>
                                </div>
                            </div>
