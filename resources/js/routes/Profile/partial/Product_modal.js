                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="productModal">{t("제품 등록")}</h5>
                        ...
                        <div className="modal-body">
                            <p className="text-center">{t("'-'를 포함해서 입력해주세요.")}</p>
                            ...
                            {product ? (
                                <p className="text-danger">{t("이전에 등록한 key는 다시 사용할 수 있습니다.")}</p>
                            ) : null}
                            <p className="text-danger" id="ex_text"></p>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-dismiss="modal">{t("닫기")}</button>
                                {product ? (
                                    <button type="submit" className="btn btn-primary btn__update__product">{t("재등록")}</button>
                                ) : (
                                    <button type="submit" className="btn btn-primary btn__post__product">{t("등록")}</button>
                                )}
                            </div>
                        </div>
                    </div>
